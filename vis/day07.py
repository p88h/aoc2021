...
class Painter:
    ...
    def update(self, view, controller):
        ...
        if len(self.ehist) > 5:
            ...
            view.font.render_to(view.win, (x-24, y+14),
                                "EST[2]: {}@{}".format(minv, minp), (240, 120, 120))
        ...
        view.font.render_to(view.win, (x-24, y-16),
                            "MIN[1]: {}@{}".format(self.thist[m1], m1), (160, 255, 160))
        ...
        pygame.draw.circle(view.win, (240, 240, 240), (x, y), 4, 1)
        view.font.render_to(view.win, (x-24, y-16),
                            "MIN[2]: {}@{}".format(self.ehist[m2], m2), (255, 160, 160))
...
def init(controller):
    with open(controller.workdir() + "/input/day07.txt") as f:
