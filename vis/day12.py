...
class Spawn:
    ...
    def update(self, view, controller):
        ...
        view.font.render_to(view.win, (10, 1040),
                            "Active boats: {} / {}".format(self.moving, self.ei), (200, 240, 200))
        view.font.render_to(view.win, (10, 1060),
                            "Last routed: {}".format(self.last), (200, 240, 200))
...
def init(controller, font):
    caves = {}
    map = {}
    visited = {}
    controller.add(Background())
    with open(controller.workdir() + "/input/day12.txt") as f:
