...
class Tile:
    ...
    def render_water(self, surface, level):
        ...
        if int(level) > self.height:
            ...
            pygame.draw.polygon(surface, (r, g, b, a),
                                [(x, yw), (x+8, yw-4), (x+16, yw), (x+8, yw+4)])
            pygame.draw.polygon(surface, (r, g, b, a + 40),
                                [(x-1, yw), (x+8, yw-5), (x+17, yw), (x+8, yw+5)], 1)
            self.covered = True
...
def init(controller):
    board = []
    with open(controller.workdir() + "/input/day09.txt") as f:
        y = 0
